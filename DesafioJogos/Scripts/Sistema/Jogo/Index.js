        ...
        "aoColumns": [
                ...
                },
              {
                  ...
                  'mRender': function (data, type, val) {
                      ...
                      html = html + (val.InEmprestado ? '' : '<a class="glyphicon glyphicon-remove" title="Excluir" aria-hidden="true" onclick="excluir(' + val.Id + ')"></a>');
                      return html;
                  }
              }],
